...
You create a little countdown app that is useful either to focus on you breath for some seconds or to count back seconds
for whatever need you have.

### Challenge

Learn about state and testing in React
...
As sometimes it is difficult to validate certain situations just by rendering the components I suggest trying to apply
